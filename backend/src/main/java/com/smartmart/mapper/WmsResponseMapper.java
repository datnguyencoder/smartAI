...
public final class WmsResponseMapper {
        ...
        public static ShiftResponse toShiftResponse(Shift shift, String cashierName) {
                return ShiftResponse.builder()
                                ...
                                .openingBalanceSourceShiftId(shift.getOpeningBalanceSourceShiftId())
                                ...
                                .staffMismatchReported(shift.getStaffMismatchReported())
                                .managerNote(shift.getManagerNote())
                                .adminNote(shift.getAdminNote())
